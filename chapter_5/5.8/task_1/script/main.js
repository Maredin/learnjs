...
//создаем колекцию WeakSet пытаемся прочитать 2 письмо, вывод true
let set = new WeakSet(messages);

console.log(set)
console.log( set.has(messages[1]) )


//удаляем второе письмо и повторно пытаемся прочитать 2 письмо, вывод false

set.delete(messages[1]);
